...
export const MOCK_EVENTS = [
  {
    ...
    fightsCount: 12,
    mainEvent: "Islam Makhachev vs Arman Tsarukyan",
  },
  {
    id: "2",
    name: "UFC Fight Night: Moreno vs Royval",
    date: "2026-02-07",
    location: "México City, México",
    status: "completed" as const,
    fightsCount: 11,
    mainEvent: "Brandon Moreno vs Brandon Royval",
  },
  {
    id: "3",
    name: "UFC 315",
  ...
  },
  {
    ...
    status: "upcoming" as const,
    fightsCount: 12,
    mainEvent: "Max Holloway vs Arnold Allen",
  },
];
