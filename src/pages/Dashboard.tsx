      ...
      <div className="container py-8 space-y-8">
        ...
        {announcement?.whatsapp && (
          <motion.div initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }}>
            <a href={announcement.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 rounded-xl border-2 border-green-500/30 bg-gradient-to-r from-green-500/10 to-green-600/5 p-5 hover:from-green-500/20 hover:to-green-600/10 transition-all shadow-lg shadow-green-500/5">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-display font-bold text-base uppercase text-green-400 tracking-wide">🔥 Grupo de MMA no WhatsApp</p>
                <p className="text-sm text-muted-foreground mt-0.5">Venha falar de MMA com a gente! Participe do grupo para ser notificado e trocar ideia sobre o octógono.</p>
              </div>
