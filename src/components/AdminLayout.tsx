...
import { Calendar, Users, Settings, ArrowLeft, Shield, Loader2, Wrench, FileText, Bell, Eye, UserCheck } from "lucide-react";
...
const adminNav = [
  ...
  { path: "/admin/fighters", label: "Atletas", icon: UserCheck },
